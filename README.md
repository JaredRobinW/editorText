...
! [En donde: 
    ...
    - Principal: Representa la pantalla principal con la barra de aplicación y el botón flotante. ] (https://github.com/JaredRobinW/editorText/blob/main/Imagen1.png)
